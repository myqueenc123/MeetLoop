...
// =========================================================================
// 📲 1. PRIMARY WEBHOOK ENDPOINT (PLACED FIRST TO PREVENT ROUTING BUGS)
// =========================================================================
...
// Wildcard Frontend Handler (Placed at the very bottom)
app.get("*", (req, res) => {
...
server.listen(PORT, "0.0.0.0", () => {
  ...
  console.log(`📡 GCash Primary Webhook Route: READY (/webhook/gcash-sms)`);
